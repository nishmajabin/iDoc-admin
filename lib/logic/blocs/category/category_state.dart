...
/// Emitted when a category name already exists in Firestore.
/// Kept separate from [CategoryError] so the UI can show
/// a targeted inline / snackbar message without conflating
/// it with network or upload failures.
class CategoryDuplicateError extends CategoryState {
  final String name;
  const CategoryDuplicateError(this.name);

  String get message => '"$name" already exists. Please use a different name.';
